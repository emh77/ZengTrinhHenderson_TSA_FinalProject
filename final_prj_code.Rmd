...
*Figure 2. Residuals for the ARIMA model for Coal.*
...
*Figure 3. Residuals for the SSES model for Coal.*
...
*Figure 4. Residuals for the StructTS model for Coal.*
...
*Figure 5. 2022 coal generation forecast for each model; the original 2022 data is in black.*  
...
*Figure 6. Residuals for SARIMA model for Gas generation data.*
```{r echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(gas_sses)
```

*Figure 7. Residuals for SSES model for Gas generation data.*
```{r echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(gas_ss_model, plot=TRUE)
```

*Figure 8. Residuals for StructTS model for Gas generation data.*
...
*Figure 9. 2022 gas generation forecast for each model; the original 2022 data is in black.*
...
*Figure 10. Residuals for SARIMA model for hydro generation.*
...
*Figure 11. Residuals for SSES model for hydro generation.*
...
*Figure 12. Residuals for StructTS model for hydro generation.*
...
*Figure 13. 2022 hydro generation forecast for each model; the original 2022 data is in black.*
...
*Figure 14. Residuals for SARIMA model for nuclear generation.*
```{r echo=FALSE, message=FALSE, warning=FALSE}
checkresiduals(nuclear_sses)
```


*Figure 15. Residuals for SSES model for nuclear generation.*
...
*Figure 16. Residuals for StructTS model for nuclear generation.*
...
*Figure 17. 2022 nuclear generation forecast for each model; the original 2022 data is in black.*
...
checkresiduals(wind_sarima_autofit, plot=TRUE)
```


*Figure 18. Residuals for SARIMA model for wind generation.*
...
*Figure 19. Residuals for SSES model for wind generation.*

```{r message=FALSE, warning=FALSE}
checkresiduals(wind_ss_model, plot=TRUE)
```


*Figure 20. Residuals for StructTS model for wind generation.*
...
*Figure 21. 2022 wind generation forecast for each model; the original 2022 data is in black.*

#### Scores for Wind Forecasts 
We calculated the accuracy scores for each model to determine the best model fit.


*Table 6. Accuracy scores for models for Wind generation.*
```{r}
#test the accuracy of the models 
...
*Figure 22. ERCOT monthly generation for each fuel type and forecasts. The forecast for each fuel type are the corresponding darker shades of each color.*
