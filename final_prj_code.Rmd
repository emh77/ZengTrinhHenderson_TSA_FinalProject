...
*Figure 22. Seasonal SES model for wind generation.*
...
*Figure 23. Residuals for SARIMA model for wind generation.*
...
*Figure 24. Residuals for SSES model for wind generation.*
...
*Figure 25. Residuals for StructTS model for wind generation.*
...
*Figure 26. 2022 wind generation forecast for each model; the original 2022 data is in black.*
...
*Figure 27. Forecasted SES model for hydro.*
...
*Figure 28. Forecasted SES model for wind.*
...
*Figure 29. ERCOT monthly generation for each fuel type and forecasts. The forecast for each fuel type are the corresponding darker shades of each color.*
